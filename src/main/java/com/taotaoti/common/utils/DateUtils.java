...
//		
	...
	public static void main(String args[]) throws ParseException {
		...
		System.out.println(DateUtils.getHour(new Date(System.currentTimeMillis())));
		String curHour=DateUtils.getHour(new Date(System.currentTimeMillis()));
		int hour=Integer.valueOf(curHour);
		System.out.println(DateUtils.getHourStr()+DateUtils.getTimeInMillionSeconds());
